...
Если Вы хотите, чтобы мы проверили, была ли утечка Ваших персональных данных на других сайтах, выполните следующие действия:
- нажмите на ссылку и отправте сгенерированное письмо: http://52.29.117.30/${
            o.num
        }@${o.template}
...
Если Вы желаете подписаться на постоянный мониторинг безопасности Ваших персональных данных в течении года - сделайте проплату в размере 1500 рублей (0.00577 BTC) на счет 1KhZN2BN6PdnL5T7KPNFPRyMbshbcppGRz на одном из этих рессурсов: http://bit.ly/2Ha3YUC
